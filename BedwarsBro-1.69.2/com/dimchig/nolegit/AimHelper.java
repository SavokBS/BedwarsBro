...
/*     */ {
/*     */   static Minecraft mc;
/*  35 */   static double aim_speed = 0.02D;
/*     */   public static boolean isActive;
/*  37 */   static double aim_treshold = 50.0D;
/*     */   
/*     */   public AimHelper() {
/*  40 */     mc = Minecraft.func_71410_x();
/*     */   }
/*     */   
/*     */   public void toggle() {
...
/* 177 */         continue;  if (MyChatListener.getEntityTeamColor(en) == CustomScoreboard.TEAM_COLOR.NONE) {
/*     */         continue;
/*     */       }
/*     */       
/* 181 */       Vec3 p_pos = getVectorWithPartialTicks((Entity)en, partialTicks);
/* 182 */       if (p_pos.func_72438_d(mod_player_pos) > 5.0D)
/*     */         continue; 
/* 184 */       double dX = mod_player_pos.field_72450_a - p_pos.field_72450_a;
/* 185 */       double dY = mod_player_pos.field_72448_b - p_pos.field_72448_b;
/* 186 */       double dZ = mod_player_pos.field_72449_c - p_pos.field_72449_c;
/* 187 */       double t_yaw = getRealYaw(myMap(Math.atan2(dZ, dX), -3.141592653589793D, Math.PI, -180.0D, 180.0D) + 90.0D);
/*     */       
/* 189 */       double d = Math.abs(mod_player_yaw - t_yaw);
/*     */       
/* 191 */       if (d < dist) {
/* 192 */         dist = d;
/* 193 */         closestPlayer = en;
/*     */       } 
/*     */     } 
...
/* 200 */     double leftSpan = leftMax - leftMin;
/* 201 */     double rightSpan = rightMax - rightMin;
/* 202 */     double valueScaled = (value - leftMin) / leftSpan;
/* 203 */     return rightMin + valueScaled * rightSpan;
/*     */   }
/*     */   
/*     */   private Vec3 getVectorWithPartialTicks(Entity en, float partialTicks) {
/* 207 */     double x = en.field_70169_q + (en.field_70165_t - en.field_70169_q) * partialTicks;
/* 208 */     double y = en.field_70167_r + (en.field_70163_u - en.field_70167_r) * partialTicks;
/* 209 */     double z = en.field_70166_s + (en.field_70161_v - en.field_70166_s) * partialTicks;
/* 210 */     return new Vec3(x, y, z);
/*     */   }
/*     */   
/*     */   private void setLineColor(Color color) {
/* 214 */     GL11.glColor4f(color.getRed(), color.getGreen(), color.getBlue(), 1.0F);
/*     */   }
/*     */ }
