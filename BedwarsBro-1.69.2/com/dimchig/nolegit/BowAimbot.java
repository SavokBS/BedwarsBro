...
/*  77 */     if (!isActive)
/*     */       return;  try {
/*  79 */       EntityPlayerSP player = mc.field_71439_g;
/*  80 */       float player_yaw = (player.field_70177_z % 360.0F + 360.0F) % 360.0F;
/*  81 */       float player_pitch = player.field_70125_A;
/*     */       
/*  83 */       Vec3 playerPos = getVectorWithPartialTicks((Entity)player, event.partialTicks);
/*     */       
/*  85 */       ArrayList<Vec3> positions = new ArrayList<Vec3>();
/*     */       
/*  87 */       if (player.func_71045_bC() == null || player.func_71045_bC().func_77973_b() != Items.field_151031_f) {
/*     */         return;
/*     */       }
/*  90 */       double timeLeft = player.func_71052_bv();
/*  91 */       double charge = Items.field_151031_f.func_77626_a(player.func_71045_bC()) - timeLeft;
/*     */       
/*  93 */       List<EntityPlayer> villagers = mc.field_71441_e.func_175644_a(EntityPlayer.class, EntitySelectors.field_94557_a);
/*     */       
/*  95 */       if (villagers == null || villagers.size() == 0)
/*  96 */         return;  EntityPlayer closestPlayer = getClosestPlayer(player, playerPos, event.partialTicks);
/*  97 */       if (closestPlayer == null)
/*  98 */         return;  Vec3 closestPlayerPos = getVectorWithPartialTicks((Entity)closestPlayer, event.partialTicks);
/*     */ 
/*     */       
/* 101 */       double dX = playerPos.field_72450_a - closestPlayerPos.field_72450_a;
/* 102 */       double dY = playerPos.field_72448_b - closestPlayerPos.field_72448_b;
/* 103 */       double dZ = playerPos.field_72449_c - closestPlayerPos.field_72449_c;
/* 104 */       double t_yaw = myMap(Math.atan2(dZ, dX), -3.141592653589793D, Math.PI, -180.0D, 180.0D);
/* 105 */       double t_pitch = myMap(Math.atan2(Math.sqrt(dZ * dZ + dX * dX), dY) + Math.PI, Math.PI, 6.283185307179586D, 90.0D, -90.0D);
/*     */ 
/*     */       
/* 108 */       GL11.glPushMatrix();
/* 109 */       GL11.glPushAttrib(8192);
/* 110 */       GL11.glTranslated(-playerPos.field_72450_a, -playerPos.field_72448_b, -playerPos.field_72449_c);
/* 111 */       GL11.glDisable(2896);
/* 112 */       GL11.glDisable(3553);
/* 113 */       GL11.glDisable(2929);
/* 114 */       GlStateManager.func_179084_k();
/* 115 */       GL11.glLineWidth(1.0F);
/*     */ 
/*     */       
/* 118 */       if (isDrawActive) {
/* 119 */         List<EntityArrow> arrows = mc.field_71441_e.func_175644_a(EntityArrow.class, EntitySelectors.field_94557_a);
/* 120 */         if (arrows != null && arrows.size() > 0) {
/* 121 */           setLineColor(arrow_collider);
/* 122 */           for (EntityArrow en : arrows) {
/* 123 */             Vec3 pos = getVectorWithPartialTicks((Entity)en, event.partialTicks);
/* 124 */             double c = 0.1D;
/* 125 */             Main.playerFocus.drawBox(pos.field_72450_a - c, pos.field_72448_b - c, pos.field_72449_c - c, pos.field_72450_a + c, pos.field_72448_b + c, pos.field_72449_c + c);
/*     */           } 
/*     */         } 
/*     */       } 
/*     */ 
/*     */       
/* 131 */       if (!GuiPlayerFocus.STATE) {
/* 132 */         setLineColor(normal_hitbox);
/* 133 */         AxisAlignedBB box = closestPlayer.func_174813_aQ();
/* 134 */         drawBox(box.field_72340_a, box.field_72338_b, box.field_72339_c, box.field_72336_d, box.field_72337_e, box.field_72334_f);
/*     */       } 
/*     */       
...
/* 158 */         AxisAlignedBB box = new AxisAlignedBB(minPos, maxPos);
...
/* 275 */       if (en == mod_player || en.func_96124_cp() == mod_player.func_96124_cp()) {
/*     */         continue;
/*     */       }
/*     */       
...
/* Location:              C:\Users\1337a\Downloads\bedwarsbro-1.69.2.jar!\com\dimchig\nolegit\BowAimbot.class
