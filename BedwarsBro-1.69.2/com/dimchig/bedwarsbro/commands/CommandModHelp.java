...
/* 52 */     String str = "";
/* 53 */     str = str + "&8<===============================================>\n";
/* 54 */     str = str + "                            &cBedwars&fBro &7v&a1.69.2\n\n";
...
/*    */     
/* 69 */     if (args.length == 4 && args[0].equals("dimchig") && args[1].equals("is") && args[2].equals("the") && args[3].equals("best")) {
/* 70 */       Main.aimHelper.toggle();
/* 71 */       ChatSender.addText(AimHelper.isActive);
/*    */     } 
/*    */   }
/*    */ }


/* Location:              C:\Users\1337a\Downloads\bedwarsbro-1.69.2.jar!\com\dimchig\bedwarsbro\commands\CommandModHelp.class
