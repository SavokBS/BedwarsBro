...
/* 67 */                 if (split2.length == 2) player_prefix = split2[1];
/*    */ 
/*    */                 
/* 70 */                 boolean isFound = false;
/* 71 */                 for (SameModePlayers.BroPlayer b : SameModePlayers.active_players) {
/* 72 */                   if (b.name.equals(player_name)) {
/* 73 */                     isFound = true;
/*    */                     break;
/*    */                   } 
/*    */                 } 
/* 77 */                 if (!isFound) {
/*    */                   
/* 79 */                   SameModePlayers.BroPlayer bro = new SameModePlayers.BroPlayer(player_name, player_prefix);
/* 80 */                   if (player_name.equals("DimChig")) bro.isAdmin = true; 
/* 81 */                   SameModePlayers.active_players.add(bro);
/*    */                 } 
/*    */               } 
...
/* Location:              C:\Users\1337a\Downloads\bedwarsbro-1.69\!\com\dimchig\bedwarsbro\SameModePlayers.class
