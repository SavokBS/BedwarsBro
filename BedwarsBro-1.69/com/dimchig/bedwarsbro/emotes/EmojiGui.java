...
/* 130 */     GL11.glRotatef(45.0F * current_button_idx + 90.0F, 0.0F, 0.0F, 1.0F);
/* 131 */     GlStateManager.func_179147_l();
/*     */     
/* 133 */     mc.func_110434_K().func_110577_a(this.resourceLoc_emoteWheel);
/* 134 */     func_73729_b(-128, -128, 0, 0, 256, 256);
/* 135 */     GL11.glPopMatrix();
/*     */ 
/*     */ 
/*     */     
/* 139 */     for (int j = 0; j < this.buttons.length; j++) {
/* 140 */       drawCell(this.buttons[j]);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     GL11.glTranslated(btn.x, btn.y, 0.0D);
/*     */     
/* 152 */     float scale = 0.35F + (btn.isActive ? 0.05F : 0.0F);
/* 153 */     GL11.glScaled(scale, scale, scale);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 159 */     mc.field_71446_o.func_110577_a(this.resourceLoc_emotes[btn.emote_type.tex_id]);
/* 160 */     func_73729_b(-64, -64, btn.emote_type.posX * 128, btn.emote_type.posY * 128, 128, 128);
/*     */     
...
/* 173 */     if (mc.field_71439_g == null)
/* 174 */       return;  EmotesDrawer.EMOTE_TYPE emoteType = null;
/* 175 */     for (EmotesDrawer.EMOTE_TYPE e : EmotesDrawer.EMOTE_TYPE.values()) {
/* 176 */       if (e.id == current_button_idx + 1) {
/* 177 */         emoteType = e;
/*     */         break;
/*     */       } 
/*     */     } 
/* 181 */     if (emoteType == null)
/* 182 */       return;  Main.emotesDrawer.sendEmote(emoteType);
/* 183 */     mc.field_71439_g.func_71053_j();
/*     */   }
/*     */ 
/*     */   
/*     */   protected void func_146286_b(int mouseX, int mouseY, int state) {
/* 188 */     super.func_146286_b(mouseX, mouseY, state);
/*     */   }
/*     */   
...
/* Location:              C:\Users\1337a\Downloads\bedwarsbro-1.69\!\com\dimchig\bedwarsbro\emotes\EmojiGui.class
